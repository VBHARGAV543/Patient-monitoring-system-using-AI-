...
const Home = () => {
  ...
  return (
    ...
    >
      <Container maxWidth="xl" sx={{ px: { xs: 2, sm: 4, md: 6 }, py: 4 }}>
        <motion.div
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
        >
          <Paper elevation={10} sx={{ p: { xs: 4, sm: 6, md: 8 }, borderRadius: 4, textAlign: 'center', mb: 8 }}>
        ...
        <Grid container spacing={{ xs: 3, sm: 4, md: 6 }} sx={{ px: { xs: 0, sm: 2, md: 4 } }}>
        ...
        <Box sx={{ textAlign: 'center', mt: 8 }}>
          <Typography variant="body2" color="white" sx={{ opacity: 0.9 }}>
            © 2026 Hospital Alarm Fatigue Monitoring System | Patient-monitoring-system-using-AI
          </Typography>
        </Box>
      </Container>
    </Box>
