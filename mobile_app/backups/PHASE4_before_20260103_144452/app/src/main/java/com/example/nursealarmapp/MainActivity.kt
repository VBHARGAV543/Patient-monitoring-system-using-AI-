...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun loadMockPatients() {
        ...
        patients.clear()
        // Real patient - can have alerts (simulated unstable vitals)
        patients.add(Patient("P001", "Patient 1", "ALERT", currentTime, true, 
            heartRate = 125, spO2 = 88, temperature = 38.5, bpSystolic = 145, bpDiastolic = 95))
        
        // Dummy patients - NEVER alerted, always STABLE with normal vitals
